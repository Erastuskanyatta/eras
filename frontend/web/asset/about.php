...
<!-- Mirrored from livedemo00.template-help.com/wt_prod-15615/about.html by HTTraQt Website Copier/1.x [Karbofos 2012-2017] Wed, 26 Aug 2020 12:45:03 GMT -->
<head>
    <!-- Site Title-->
    <title>About</title>
    ...
    <!-- Stylesheets-->
    <link rel="stylesheet" type="text/css" href="../../fonts.googleapis.com/cssd94b.css?family=Libre+Franklin:200,300,500,600,300italic%7CCormorant+Garamond:300,400,400i,600,700">
          ...
          <nav class="rd-navbar rd-navbar_inverse" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-sm-device-layout="rd-navbar-fixed" data-md-layout="rd-navbar-fixed" data-md-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-static" data-lg-device-layout="rd-navbar-fixed" data-xl-device-layout="rd-navbar-static" data-xl-layout="rd-navbar-static" data-stick-up-clone="false" data-sm-stick-up="true" data-md-stick-up="true" data-lg-stick-up="true" data-xl-stick-up="true" data-xxl-stick-up="true" data-lg-stick-up-offset="120px" data-xl-stick-up-offset="35px" data-xxl-stick-up-offset="35px" data-body-class="">
            <div class="rd-navbar-inner rd-navbar-search-wrap">
              ...
              <div class="rd-navbar-panel rd-navbar-search_collapsable">
                ...
                <!-- RD Navbar Brand-->
                <div class="rd-navbar-brand"><a class="brand-name" href="index-2.html"><img src="images/logo-140x44.png" alt="" width="140" height="44"/></a></div>
              </div>
              <!-- RD Navbar Nav-->
              <div class="rd-navbar-nav-wrap rd-navbar-search_not-collapsable">
                ...
                <div class="rd-navbar-search rd-navbar-search_toggled rd-navbar-search_not-collapsable">
                  <form class="rd-search" action="../../external.html?link=https://livedemo00.template-help.com/wt_prod-15615/search-results.html" method="GET" data-search-live="rd-search-results-live">
                    <div class="form-wrap">
      ...
      <section class="section-lg bg-default section-limit">
        <div class="container">
          <div class="row row-50 align-items-md-center">
            <div class="col-md-6">
              <h3 class="wow fadeInUpSmall" data-wow-delay=".2s" data-wow-duration="1.2s">ABOUT OUR STORE</h3>
            ...
            <div class="col-md-6 text-center"><img class="img-circle wow fadeInUpSmall" src="images/about-3-418x418.jpg" alt="" width="418" height="418"/>
            </div>
          </div>
        </div>
      </section>
      <section class="section-limit bg-gray-lighter bg-image bg-image-1">
        <div class="container">
          <div class="row justify-content-md-end">
            <div class="col-md-7 col-lg-6 section-xl section-xl_bigger">
              <h3 class="wow fadeInUpSmall" data-wow-delay=".2s" data-wow-duration="1.2s">Best US & UK furniture brands</h3>
              <p class="wow fadeInUpSmall" data-wow-delay=".5s" data-wow-duration="1.2s">We sell only the best furniture sets and pieces, manufactured in either US, Canada or the UK...  All of our range includes only brands with long-lasting reputation, which have been proved as popular among people for years...</p>
            </div>
          </div>
        </div>
      </section>
      <section class="section-limit bg-default bg-image bg-image-2">
        <div class="container">
          <div class="row">
            <div class="col-md-7 col-lg-6 section-xl section-xl_bigger">
              <h3 class="wow fadeInUpSmall" data-wow-delay=".2s" data-wow-duration="1.2s">A VARIETY OF HOME FURNITURE</h3>
              <p class="wow fadeInUpSmall" data-wow-delay=".5s" data-wow-duration="1.2s">When you're looking for a sofa or a chair, comfort and durability must come first! With our range of cozy daybeds, recliners and many other pieces we can guarantee that you'll find it! We provide a variety of home furniture from acknowledged manufacturers. At Furni, you can easily purchase stylish tables, chairs, and other high-quality furniture for your house.</p>
            </div>
          </div>
        </div>
      </section>
      <section class="section-limit bg-accent bg-image bg-image-3">
        <div class="container">
          <div class="row justify-content-md-end">
            <div class="col-md-7 col-lg-6 section-xl section-xl_bigger">
              <h3 class="wow fadeInUpSmall" data-wow-delay=".2s" data-wow-duration="1.2s">Agreeable pricing for a great quality</h3>
              <p class="wow fadeInUpSmall" data-wow-delay=".5s" data-wow-duration="1.2s">The pricing policy that we have put in place makes affordability a centre point... While for some people quality means sky-high cost, for us the balance between these two is reached easily</p>
            </div>
          </div>
        </div>
      </section>
      <section class="section-limit bg-default bg-image bg-image-5">
        <div class="container">
          <div class="row">
            <div class="col-md-7 col-lg-6 section-xl section-xl_bigger">
              <h3 class="wow fadeInUpSmall" data-wow-delay=".2s" data-wow-duration="1.2s">Stock sales all <br class="visible-lg-inline"> the time...</h3>
              <p class="wow fadeInUpSmall" data-wow-delay=".5s" data-wow-duration="1.2s">When you're looking for a sofa or a chair, comfort and durability must come first!  With our range of cozy daybeds, recliners and many other pieces we can guarantee that you'll find it!</p>
            </div>
          </div>
        </div>
      </section>
